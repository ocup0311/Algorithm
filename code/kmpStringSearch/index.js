...
const input3 = {
  dataPool:
    'abcdabcdabcdabcdababcdabcgabcdabcgabcdabcgcgabcdabcdabcgdabcgdabcgdabcgabcddabcgdabcgfabcdabcg',
  target: 'abcdabcg',
}
const input4 = builtInput({ amountT: 10, amountD: 20 }, true)

runTest(input1, kmp)
runTest(input1, kmp2, false)

runTest(input2, kmp)
runTest(input2, kmp2, false)

runTest(input3, kmp)
runTest(input3, kmp2, false)

runTest(input4, kmp)
runTest(input4, kmp2, false)
